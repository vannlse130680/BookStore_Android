...
import com.example.bookstore.viewholder.CartViewHolder;
...
public class CartActivity extends AppCompatActivity {
    ...
    private Button nextProcessBtn, buyBtn;
        ...
        cartRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(!dataSnapshot.child(Prevalent.currentOnlineUser.getPhone()).exists()) {
                    txtTotalAmount.setText("Empty Cart");
                    txtMsg1.setVisibility(View.VISIBLE);
                    txtMsg1.setText("Your cart is empty ! Let's buy some new boooks!");
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()){
                    ...
                    if (shippingState.equals("shipped")){
                        txtTotalAmount.setText(" Order is shipped successfully!");
                        recyclerView.setVisibility(View.GONE);
                        txtMsg1.setVisibility(View.VISIBLE);
                        txtMsg1.setText("Dear "+userName+","+"\nCongratulations, your final order has been shipped successfully. Soon you will receive your order at your door step.");
                        nextProcessBtn.setVisibility(View.GONE);
